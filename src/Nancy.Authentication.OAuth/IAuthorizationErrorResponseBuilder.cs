namespace Nancy.Authentication.OAuth
{
    ...
    {
        AuthorizationErrorResponse Build(AuthorizationErrorType errorType, AuthorizationCodeRequest request);
    }
    ...
    public class AuthorizationErrorResponseBuilder : IAuthorizationErrorResponseBuilder
    {
        ...
        public AuthorizationErrorResponse Build(AuthorizationErrorType errorType, AuthorizationCodeRequest request)
        {
            var descriptions =
